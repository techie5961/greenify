async function spa(event,url){
    ...
    if(response.ok){
      window.MyFunc={};
       ...
       div.innerHTML=data;
       let oldCss=document.querySelectorAll('link.css');
       if(oldCss){
       ...
       let newCss=div.querySelectorAll('link.css');
       if(newCss){
       ...
       let newStyle=div.querySelector('style');
       if(newStyle){
        await new Promise(function(resolve){
    ...
    await new Promise((resolve)=>{
      ...
      resolve();
       ...
       let oldJs=document.querySelectorAll("script.js");
       ...
       let newJs=div.querySelectorAll('script.js');
       if(newJs){
        for(let js of newJs){
           await new Promise((resolve)=>{
  ...
  script.textContent=js.textContent;
      ...
      document.querySelector('main').innerHTML=`<div class="column flex-auto no-select g-5 justify-center">
